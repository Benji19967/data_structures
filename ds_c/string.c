...
int main() {
  ...
  size_t nbytes_1 = sprintf(buffer_1, "-> %d", value_1) + 1;  // +1 for the '\0'
  printf("nbytes_sprintf: %ld\n", nbytes_1);
  ...
  size_t nbytes_2 = snprintf(NULL, 0, "-> %d", value_2) + 1;  // +1 for the '\0'
  printf("nbytes_snprintf: %ld\n", nbytes_2);
